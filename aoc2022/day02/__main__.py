...
from aoc2022.day02 import solve_part_a, solve_part_b
...
def show_output(part: Optional[str] = None):
    ...
    if part is None or part.lower() == "a":
        print_part_solution(2, "A", solve_part_a())
    if part is None or part.lower() == "b":
        print_part_solution(2, "B", solve_part_b())
