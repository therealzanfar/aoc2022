...
from aoc2022.day03 import solve_part_a, solve_part_b
...
def show_output(part: Optional[str] = None):
    ...
    if part is None or part.lower() == "a":
        print_part_solution(3, "A", solve_part_a())
    if part is None or part.lower() == "b":
        print_part_solution(3, "B", solve_part_b())
